...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Rsatsne_cpp(X1, X2, mat12, mat21, nk1, nk2, no_dims, perplexity, theta, verbose, max_iter, distance_precomputed, Y_in, init, stop_lying_iter, mom_switch_iter, momentum, final_momentum, binding_force, coupled_period, uncoupled_period, eta, exaggeration_factor, num_threads));
...
static const R_CallMethodDef CallEntries[] = {
    {"_Rsatsne_Rsatsne_cpp", (DL_FUNC) &_Rsatsne_Rsatsne_cpp, 24},
